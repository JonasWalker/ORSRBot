...
def goToBank():
    ...
    # if closed
        # open
    # find on checkpoint 1
    # click on checkpoint 1
    # find on checkpoint 2
    # click on checkpoint 2
    # find on checkpoint 3
    # click on checkpoint 3
    # find on checkpoint 4
    # click on checkpoint 4
